...
let questions = [
    new Question(
        'Hyper Text Markup Language Stands For?', ['JQuery','BOOTSTRAP','CSS','HTML'], 'HTML'
    ),
    new Question(
        'Cascading Style Sheet Stands For?', ['HTML','JQUERY','CSS','XML'],'CSS'
    ),
    new Question(
        'Which is a javaScript FrameWork?',['React','Laravel','Django','SCSS'],'React'
    ),
    new Question(
